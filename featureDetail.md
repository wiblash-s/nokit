...
> - **Workshop maps**: Installed workshop maps are fetched live from the server via RCON (`maps *`) through `GET /api/servers/:id/maps/workshop`. Users can input a workshop ID and load it via RCON `host_workshop_map <workshopid>` command.
